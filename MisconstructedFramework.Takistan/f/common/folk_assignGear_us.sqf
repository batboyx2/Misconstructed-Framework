...
// LOADOUT: MEDIC
	case "m":
	{
		{_unit addMagazine "ACE_LargeBandage"} forEach [1,2,3,4];
		...
		_unit addWeapon _bagmedium;
		_bool = [_unit, _carbinemag, 5] call ACE_fnc_PackMagazine;
		_bool = [_unit, "ACE_LargeBandage", 20] call ACE_fnc_PackMagazine;
		_bool = [_unit, "ACE_Morphine", 15] call ACE_fnc_PackMagazine;
		_bool = [_unit, "ACE_Epinephrine", 15] call ACE_fnc_PackMagazine;
		_bool = [_unit, "ACE_Medkit", 10] call ACE_fnc_PackMagazine;
		_bool = [_unit, _smokegrenade, 5] call ACE_fnc_PackMagazine;
		[_unit, _bagMedium] call ACE_fnc_PutWeaponOnBack;
